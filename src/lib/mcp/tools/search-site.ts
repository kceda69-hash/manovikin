...
const PAGES = [
  {
    path: "/",
    title: "MANOVIK AI — Sovereign AI Coding Agent",
    keywords: ["home", "landing", "manovik"],
  },
  { path: "/setup", title: "Setup MANOVIK", keywords: ["install", "setup", "getting started"] },
  {
    path: "/students",
    title: "MANOVIK for Students",
    keywords: ["students", "education", "discount"],
  },
  ...
  {
    path: "/vs-cursor",
    title: "MANOVIK vs Cursor",
    keywords: ["cursor", "comparison", "alternative"],
  },
  ...
  { path: "/vs-windsurf", title: "MANOVIK vs Windsurf", keywords: ["windsurf", "comparison"] },
  {
    ...
    title: "MANOVIK vs GitHub Copilot",
    keywords: ["copilot", "github", "comparison"],
  },
  {
...
export default defineTool({
  ...
  inputSchema: {
    query: z
      ...
      .min(1)
      .max(200)
      .describe("Search query (matched against title and keywords)."),
