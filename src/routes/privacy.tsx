...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "How MANOVIK AI collects, uses, stores, and protects your personal data.",
      },
      ...
      { name: "twitter:title", content: "Privacy Policy — MANOVIK AI" },
      {
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10">
        ...
        <section className="mt-8 space-y-6 text-sm leading-relaxed text-muted-foreground">
          <p>
            MANOVIK AI ("we") respects your privacy. This policy describes what data we collect,
            why, and your rights.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Payments: order/payment IDs and receipts (card data is handled solely by Razorpay; we
              never see it).
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Send essential transactional emails (you can unsubscribe from marketing at any time).
            </li>
          </ul>

          <h2 className="text-xl font-semibold text-foreground">Sharing</h2>
          <p>
            We do not sell personal data. We share data only with sub-processors required to operate
            the service (hosting, database, email, payments) under appropriate safeguards.
          </p>

          <h2 className="text-xl font-semibold text-foreground">Retention</h2>
          <p>
            Data is retained while your account is active and for a reasonable period afterwards for
          ...
          <p>
            ...
            <a className="text-primary" href="mailto:privacy@manovik.in">
              privacy@manovik.in
            </a>
            .
          </p>
          ...
          <p>
            Data is encrypted in transit (TLS) and at rest. Threads are scoped per-user with
            row-level security.
          </p>
