  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MANOVIK AI vs Cursor AI — The Sovereign Alternative" },
      {
        ...
        content: "Head-to-head: privacy, deployment, pricing, and capabilities. Why developers pick MANOVIK over Cursor.",
      },
      { property: "og:url", content: "https://manovik.in/vs-cursor" },
      { property: "og:type", content: "article" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "MANOVIK AI vs Cursor AI" },
      { name: "twitter:description", content: "The sovereign, lifetime-priced Cursor alternative." },
    ],
...
function VsCursorPage() {
  const rows: Array<{ feature: string; manovik: string; cursor: string }> = [
    { feature: "Pricing model", manovik: "Lifetime — one-time payment", cursor: "Subscription, per seat / month" },
    { feature: "Sovereign / self-hosted deployment", manovik: "Yes — on your infra", cursor: "No — cloud only" },
    { feature: "Local model support", manovik: "Yes (Ollama / vLLM / custom endpoints)", cursor: "Limited; advanced features cloud-only" },
    { feature: "Code privacy", manovik: "Your repo never leaves your network in sovereign mode", cursor: "Code sent to Cursor's cloud" },
    { feature: "Multi-language fluency", manovik: "100+ languages with per-language memory", cursor: "Strong but cloud-tied" },
    { feature: "Vendor lock-in", manovik: "Open architecture, swappable models", cursor: "Tightly coupled to Cursor cloud" },
    { feature: "Pricing transparency", manovik: "Public, one-time, no metered seats", cursor: "Per-seat, plan-tiered" },
  ];

  return (
    <main className="mx-auto max-w-4xl px-6 py-16 text-foreground">
      <nav className="text-sm text-muted-foreground mb-6">
        <Link to="/" className="hover:underline">Home</Link> / <span>vs Cursor AI</span>
      </nav>
      ...
      <p className="text-lg text-muted-foreground mb-10">
        ...
        infrastructure, and doesn't lock you into a subscription? Here's the honest
        head-to-head.
      </p>
      ...
      <section className="mb-12">
        ...
        <p className="leading-relaxed">
          Cursor is an excellent cloud-first AI IDE — but every keystroke, file, and prompt
          flows through their servers, and you pay monthly per seat forever. MANOVIK AI is
          built for teams who need <strong>sovereign deployment</strong>, <strong>local model
          support</strong>, and <strong>lifetime pricing</strong>. Same agentic power, none of the
          recurring bill or data exfiltration.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <ul className="space-y-3 list-disc pl-6">
          <li><strong>Privacy:</strong> proprietary code, customer data, and secrets never leave your perimeter in MANOVIK's sovereign mode.</li>
          <li><strong>Cost:</strong> one lifetime payment replaces ~$240/year/seat indefinitely.</li>
          <li><strong>Control:</strong> swap models freely — Claude, Gemini, GPT, local Llama, Qwen — without changing tools.</li>
          <li><strong>Compliance:</strong> easier path to SOC2, HIPAA, GDPR, and India's DPDP requirements when inference stays on-prem.</li>
        </ul>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-muted-foreground">Yes — especially if privacy, local models, or lifetime pricing matter to you.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-muted-foreground">Cursor is subscription-only. MANOVIK offers a lifetime plan — pay once, use forever.</p>
          </div>
        </div>
      </section>
