    ...
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <header className="mt-6 space-y-3">
        ...
        <p className="text-lg text-muted-foreground">
          Claude Code and Cursor solve the same problem — AI that ships code —
          from opposite ends of the workflow. Claude Code lives in your
          terminal; Cursor lives inside a forked VS Code. Here's a concrete
          side-by-side, and where MANOVIK fits for teams that want the agentic
      ...
      <section className="mt-10 space-y-4">
        ...
        <p className="text-muted-foreground">
          Claude Code's pay-per-token model is honest but unbounded — a
          long refactor against Opus can quietly cross $20 in a single
          session. Cursor's $20/month Pro plan is predictable but caps
          "fast" requests; heavy agent users hit the slow queue by
          mid-month. Neither model is wrong; they optimize for different
          usage shapes. A one-off migration favors Claude Code; steady
          daily use favors Cursor.
        </p>
      </section>
      ...
      <section className="mt-10 space-y-4 rounded-lg border border-primary/20 bg-primary/5 p-6">
        ...
        <p className="text-muted-foreground">
          MANOVIK is the sovereign alternative for teams that like the
          agentic power of both Claude Code and Cursor but need private,
          self-hosted deployments — regulated industries, air-gapped
          environments, or anyone tired of per-seat SaaS pricing.
        </p>
        <ul className="ml-5 list-disc space-y-2 text-muted-foreground">
          <li>Runs on your infrastructure — bring your own Anthropic, OpenAI, or local Ollama / vLLM model.</li>
          <li>Headless like Claude Code, editor-agnostic, and MCP-native on both client and server.</li>
      ...
      <section className="mt-10 space-y-4">
        ...
        <ul className="ml-5 list-disc space-y-2 text-muted-foreground">
          <li>
            <strong>Pick Claude Code</strong> if you live in the terminal,
            want scripted / CI runs, and prefer keeping your existing editor.
          </li>
          <li>
            <strong>Pick Cursor</strong> if inline tab-completion and
            hunk-level accept/reject inside the editor matter more than
            headless automation.
          </li>
          <li>
            <strong>Pick MANOVIK</strong> if data can't leave your
            perimeter, or you want lifetime pricing instead of a
            subscription or a metered API bill.
          </li>
        </ul>
      </section>
    </main>
