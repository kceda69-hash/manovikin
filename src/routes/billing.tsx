...
export const Route = createFileRoute("/billing")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "View your MANOVIK plan, purchase history, and download receipts.",
      },
          ...
          <Card className="mt-3 overflow-hidden">
            ...
            {loading ? (
              ...
              rows.map((r) => (
                <div
                  key={r.id}
                  className="grid grid-cols-12 items-center gap-2 border-b border-border/40 px-4 py-3 text-sm last:border-0"
                >
