  ...
  head: () => ({
    meta: [
      { title: "Refund & Cancellation Policy — MANOVIK AI" },
      {
        name: "description",
        content:
          "MANOVIK AI refund, cancellation, and shipping policy for digital subscriptions and lifetime purchases.",
      },
      ...
      { name: "twitter:title", content: "Refund & Cancellation Policy — MANOVIK AI" },
      {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 space-y-6 text-sm leading-relaxed text-muted-foreground">
        ...
        <p>
          MANOVIK AI is a 100% digital SaaS product. There is no physical shipment. Access is
          granted instantly on successful payment.
        </p>
        ...
        <p>
          Because MANOVIK delivers compute and AI services instantly, all sales are generally final.
          However, we offer a discretionary refund within 7 days of purchase if the service was
          materially non-functional on our side. Email{" "}
          <a className="text-primary" href="mailto:support@manovik.in">
            support@manovik.in
          </a>{" "}
          with your payment ID and we will respond within 3 business days.
        </p>

        <h2 className="text-xl font-semibold text-foreground">Refund Method</h2>
        <p>
          Approved refunds are issued to the original payment method via Razorpay within 5–10
          business days.
        </p>

        <h2 className="text-xl font-semibold text-foreground">Failed Payments</h2>
        <p>
          If your account was debited but no plan was activated, contact{" "}
          <a className="text-primary" href="mailto:support@manovik.in">
            support@manovik.in
          </a>{" "}
          with your Razorpay Order ID. Razorpay typically auto-reverses failed authorizations within
          5–7 business days.
        </p>
      </main>
    </div>
