...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "MANOVIK AI is an autonomous AI agent that codes, builds, and ships — your futuristic AI employee." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@manovikai" },
      { name: "twitter:title", content: "MANOVIK AI" },
      { name: "twitter:description", content: "MANOVIK AI is an autonomous AI agent that codes, builds, and ships — your futuristic AI employee." },
