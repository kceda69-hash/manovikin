  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "windsurf ai coding agent, Windsurf alternative, Codeium Windsurf, sovereign AI IDE, self-hosted AI coding",
      },
      { property: "og:title", content: "MANOVIK AI vs Windsurf — Sovereign Alternative" },
      {
        property: "og:description",
        content:
          "Head-to-head: sovereign hosting, local models, lifetime pricing vs Windsurf Pro subscription.",
      },
  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-16 text-foreground">
      <nav className="text-sm text-muted-foreground mb-6">
        ...
        / <span>vs Windsurf</span>
      </nav>

      <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">MANOVIK AI vs Windsurf</h1>
      <p className="text-lg text-muted-foreground mb-10">
        ...
        built for teams who need privacy and cost predictability.
      </p>
      ...
      <section className="mb-12">
        ...
        <p className="leading-relaxed">
          ...
          capabilities while letting you run the entire stack on your own infrastructure with local
          models, and replaces the subscription with a one-time lifetime payment.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <ul className="space-y-3 list-disc pl-6">
          ...
          <li>
            <strong>Total cost:</strong> a lifetime license replaces ~$180/year/user, forever.
          </li>
          <li>
            <strong>Model choice:</strong> run Claude, Gemini, GPT, or local Llama/Qwen without
            changing IDE.
          </li>
          <li>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Windsurf Pro is a monthly per-user subscription. MANOVIK's lifetime plan is a single
              payment — most teams break even inside 12 months.
            </p>
          </div>
        </div>
      </section>
